...
@section('content')
    ...
    <div class="breadcrumbs-area position-relative  bg-warning">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-0 col-md-8 offset-md-2 col-custom">
                    <div class="product-details-img">
                        <div class="single-product-img swiper-container gallery-top popup-gallery">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a class="w-100" href="{{ asset('assets/images/product/honey2.jpg') }}">
                                        <img class="w-100" src="{{ asset('assets/images/product/honey2.jpg') }}" alt="Product">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a class="w-100" href="{{ asset('assets/images/product/honey3.3.jpg') }}">
                                        <img class="w-100" src="{{ asset('assets/images/product/honey3.3.jpg') }}"  alt="Product">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a class="w-100" href="{{ asset('assets/images/product/honey4.jpg') }}">
                                        <img class="w-100" src="{{ asset('assets/images/product/honey4.jpg') }}" alt="Product">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a class="w-100" href="{{ asset('assets/images/product/honey1.jpg') }}">
                                        <img class="w-100" src="{{ asset('assets/images/product/honey1.jpg') }}" alt="Product">
                                    </a>
                                </div>
                        ...
                        <div class="single-product-thumb swiper-container gallery-thumbs">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/product/honey2.jpg') }}" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/product/honey3.3.jpg') }}" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/product/honey4.jpg') }}" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/product/honey1.jpg') }}" alt="Product">
                                </div>
                                ...
                                <div class="review_address_inner">
                                    ...
                                    <div class="pro_review mb-5">
                                        <div class="review_thumb">
                                            <img alt="review images" src="assassets/images/product/honey2.2.jpg">
                                        </div>
                                ...
                                <div class="single-product position-relative mb-30">
                                    <div class="product-image">
                                        <a class="d-block" href="product-details.html">
                                            <img src="{{ ('assets/images/product/honey1.jpg') }}" alt="" class="product-image-1 w-100">
                                            <img src="{{ ('assets/images/product/honey1.1.jpg') }}" alt="" class="product-image-2 position-absolute w-100">
                                        </a>
